// lib/utils/app_texts.dart

class AppTexts {
  static String get(String key, String lang) {
    // Eğer anahtar varsa getir, yoksa 'MISSING: key' döndür
  ...
  static final Map<String, Map<String, String>> _localizedValues = {
    // ==================================================
    // ANA MENÜ (Sorunlu olan kısım burasıydı)
    // ==================================================
    ...
    'locked_msg': {
      'TR': 'Önceki seviyeyi tamamla!',
      'EN': 'Complete previous level!'
    },

    // --- GENEL OYUN METİNLERİ ---
    ...
    'next_level': {'TR': 'SONRAKİ SEVİYE', 'EN': 'NEXT LEVEL'},
    'main_menu': {'TR': 'ANA MENÜ', 'EN': 'MAIN MENU'},
    'stage_prefix': {'TR': 'AŞAMA', 'EN': 'STAGE'},

    // --- LEVEL 1: TERMODİNAMİK ---
    'l1_title': {'TR': 'SEVİYE 1: ISI DENGESİ', 'EN': 'LEVEL 1: HEAT BALANCE'},
    'l1_story': {
      'TR':
          "Boreas İstasyonu Dış Kapısı.\nHava -60°C. Kapı kilitli.\nTermal denge için sistemin net enerjisini '0' yap.",
      'EN':
          "Boreas Station Outer Door.\nTemp -60°C. Locked.\nSet net energy to '0' for thermal balance."
    },
    'l1_task': {'TR': 'SORU İŞARETİ (?) KAÇ OLMALI?', 'EN': 'VALUE OF (?)?'},
    'l1_s1_story': {
      'TR': "Dış Kapı (-60°C). Kapı kilitli.\nEnerji akışını dengele (Net: 0).",
      'EN': "Outer Door (-60°C). Locked.\nBalance energy flow (Net: 0)."
    },
    'l1_s1_task': {'TR': 'SORU İŞARETİ (?) KAÇ OLMALI?', 'EN': 'VALUE OF (?)?'},
    'l1_s2_story': {
      'TR': "Sesli doğrulama isteniyor.\nBu bilmecenin cevabı nedir?",
      'EN': "Voice auth required.\nWhat is the answer?"
    },
    'l1_s2_riddle': {
      'TR':
          "\"Kanadım yok uçarım. Gözüm yok ağlarım.\nKaranlık beni takip eder.\nBen neyim?\"",
      'EN':
    ...
    'l1_s3_story': {
      'TR':
          "Basınç arttı! Valfleri ASAL SAYI sırasına göre aç.\n(2, 3, 5, 7...)",
      'EN':
          "Pressure rising! Open valves in PRIME NUMBER order.\n(2, 3, 5, 7...)"
    },
    'l1_reward': {
      'TR': 'Kutuplar Tamamlandı.\nVeri Parçası: C-7',
      'EN': 'Poles Completed.\nData Fragment: C-7'
    },
    ...
    'l2_story': {
      'TR':
          "Laboratuvar. Buz çekirdeği analizi.\nVirüsü izole etmek için katmanları GÜNÜMÜZDEN GEÇMİŞE sırala.",
      'EN':
          "Lab. Ice core analysis.\nOrder layers from PRESENT to PAST to isolate virus."
    },
    'l2_s1_story': {
      'TR':
          "Laboratuvar. Virüsü bulmak için katmanları\nYENİDEN ESKİYE doğru sırala.",
      'EN': "Lab. Order layers from NEW to OLD\nto isolate the virus."
    },
    ...
    'l2_s3_story': {
      'TR':
          "Buz erime hızı arttı.\nDakikada 5cm eriyorsa, 300cm buz kaç dakikada erir?",
      'EN': "Ice melting fast.\nIf 5cm melts per min, how long for 300cm?"
    },
    'l2_s3_input': {'TR': 'DAKİKAYI GİR', 'EN': 'ENTER MINUTES'},
    'l2_reward': {
      'TR': 'Okyanus Tamamlandı.\nVeri Parçası: D-6',
      'EN': 'Ocean Completed.\nData Fragment: D-6'
    },
    ...
    'l3_s1_story': {
      'TR': "Pusula sapmış (+5 Doğu).\nŞifreyi çöz: J-K-N-G-T",
      'EN': "Compass deviated (+5 East).\nDecode: J-K-N-G-T"
    },
    'l3_s1_input': {'TR': 'ŞİFREYİ GİR', 'EN': 'ENTER PASSWORD'},
    'l3_s2_story': {
      'TR': "Acil durum sinyali alınıyor.\n... --- ... (Bu ne anlama gelir?)",
      'EN': "Emergency signal received.\n... --- ... (Meaning?)"
    },
    'l3_s2_opt1': {'TR': 'MERHABA (HELLO)', 'EN': 'HELLO'},
    'l3_s2_opt2': {'TR': 'YARDIM (SOS)', 'EN': 'SOS'},
    'l3_s3_story': {
      'TR': "Sinyal çok gürültülü.\nFrekansı 440 Hz (La Notası) yap.",
    ...
    'l4_s1_story': {
      'TR':
          "Navigasyon.\n(C7, D6, E5) birleştir.\nSon parça (Kutup Yıldızı) neresi?",
      'EN':
    ...
    'l4_s2_story': {
      'TR':
          "Yakıt karışımı.\nHidrojen (1) ve Oksijen (8) atom ağırlıkları oranı nedir?",
    ...
    'l4_s3_story': {
      'TR':
          "Sistem aşırı ısındı.\nMAVİ'ye basma. KIRMIZI'ya basma. YEŞİL'e bas.",
      'EN': "System Overheat.\nDon't press BLUE. Don't press RED. Press GREEN."
    },
    'l4_reward': {
      'TR': "BÖLGE 1 TAMAMLANDI.\nSıradaki: OKYANUS.",
      'EN': "ZONE 1 COMPLETED.\nNext: OCEAN."
    },
    ...
    'redirect_msg': {
      'TR': 'Ödeme sayfasına yönlendiriliyorsunuz...',
